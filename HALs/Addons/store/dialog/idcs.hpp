...
#define UICTRL(IDC)  ((GET_DISPLAY getVariable ["HALs_store_idc", controlNull]) controlsGroupCtrl IDC)
...
#define STAT_BARS [\
    [UICTRL(IDC_STATS_PROGRESS_1), UICTRL(IDC_STATS_PROGRESS_TEXT_1)],\
    [UICTRL(IDC_STATS_PROGRESS_2), UICTRL(IDC_STATS_PROGRESS_TEXT_2)],\
    [UICTRL(IDC_STATS_PROGRESS_3), UICTRL(IDC_STATS_PROGRESS_TEXT_3)],\
    [UICTRL(IDC_STATS_PROGRESS_4), UICTRL(IDC_STATS_PROGRESS_TEXT_4)],\
    [UICTRL(IDC_STATS_PROGRESS_5), UICTRL(IDC_STATS_PROGRESS_TEXT_5)]\
]
