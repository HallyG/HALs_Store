...
#define STAT_BARS [\
    [UICGCTRL(IDC_STATS_PROGRESS_1), UICGCTRL(IDC_STATS_PROGRESS_TEXT_1)],\
    [UICGCTRL(IDC_STATS_PROGRESS_2), UICGCTRL(IDC_STATS_PROGRESS_TEXT_2)],\
    [UICGCTRL(IDC_STATS_PROGRESS_3), UICGCTRL(IDC_STATS_PROGRESS_TEXT_3)],\
    [UICGCTRL(IDC_STATS_PROGRESS_4), UICGCTRL(IDC_STATS_PROGRESS_TEXT_4)],\
    [UICGCTRL(IDC_STATS_PROGRESS_5), UICGCTRL(IDC_STATS_PROGRESS_TEXT_5)]\
]
